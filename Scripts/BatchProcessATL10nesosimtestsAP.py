...
def main(fileT, beamNum):
	...
	if (nesosim==1):
		...
		dF = cF.gridNESOSIMtoFreeboard(dF, mapProj, fileNESOSIM, dateStr, outSnowVar='snow_depth_Ne5', outDensityVar='snow_density_Ne5')
	...
	if (nesosim2==1):
		...
		dF = cF.gridNESOSIMtoFreeboard(dF, mapProj, fileNESOSIM, dateStr, outSnowVar='snow_depth_Ne5cs1', outDensityVar='snow_density_Ne5cs1')
	...
	if (nesosim3==1):
		...
		dF = cF.gridNESOSIMtoFreeboard(dF, mapProj, fileNESOSIM, dateStr, outSnowVar='snow_depth_Ne5cs2', outDensityVar='snow_density_Ne5cs2')
	...
	if (nesosim4==1):
		...
		dF = cF.gridNESOSIMtoFreeboard(dF, mapProj, fileNESOSIM, dateStr, outSnowVar='snow_depth_Ne5cs3', outDensityVar='snow_density_Ne5cs3')
	...
	if (nesosimdisttributed==1):
		...
		dF = cF.distributeSnow(dF, inputSnowDepth='snow_depth_Ne5', outSnowVar='snow_depth_Ne5dist', consIterations=11, gridSize=100000)

		dF = cF.distributeSnow(dF, inputSnowDepth='snow_depth_Ne5cs1', outSnowVar='snow_depth_Ne5cs1dist', consIterations=11, gridSize=100000)

		dF = cF.distributeSnow(dF, inputSnowDepth='snow_depth_Ne5cs2', outSnowVar='snow_depth_Ne5cs2dist', consIterations=11, gridSize=100000)

		dF = cF.distributeSnow(dF, inputSnowDepth='snow_depth_Ne5cs3', outSnowVar='snow_depth_Ne5cs3dist', consIterations=11, gridSize=100000)
	...
	if (nesosimdisttributed==1):
		...
		dF = cF.getSnowandConverttoThickness(dF, snowDepthVar='snow_depth_Ne5dist', snowDensityVar='snow_density_Ne5', outVar='ice_thickness_Ne5dist', rhoi=1)
		dF = cF.getSnowandConverttoThickness(dF, snowDepthVar='snow_depth_Ne5cs1dist', snowDensityVar='snow_density_Ne5cs1', outVar='ice_thickness_Ne5cs1dist', rhoi=1)
		dF = cF.getSnowandConverttoThickness(dF, snowDepthVar='snow_depth_Ne5cs2dist', snowDensityVar='snow_density_Ne5cs2', outVar='ice_thickness_Ne5cs2dist', rhoi=1)
		dF = cF.getSnowandConverttoThickness(dF, snowDepthVar='snow_depth_Ne5cs3dist', snowDensityVar='snow_density_Ne5cs3', outVar='ice_thickness_Ne5cs3dist', rhoi=1)
...
if __name__ == '__main__':
	...
	snowPath='/cooler/scratch1/aapetty/Data/NESOSIM/OSISAF-MERGED_ERA5_sf_SICCDR_Rhovariable_IC4_DYN1_WP1_LL1_WPF5.8e-07_WPT5_LLF2.9e-07-100kmvac/final/'
	
	snowPath2='/cooler/scratch1/aapetty/Data/NESOSIM/OSISAF-MERGED_ERA5_sf_SICCDR_Rhovariable_IC4_DYN1_WP1_LL1_WPF5.8e-07_WPT5_LLF2.9e-07-100kmvacCS/final/'
	snowPath3='/cooler/scratch1/aapetty/Data/NESOSIM/OSISAF-MERGED_ERA5_sf_SICCDR_Rhovariable_IC4_DYN1_WP1_LL1_WPF5.8e-07_WPT5_LLF5.8e-07-100kmvacCS/final/'
	snowPath4='/cooler/scratch1/aapetty/Data/NESOSIM/OSISAF-MERGED_ERA5_sf_SICCDR_Rhovariable_IC4_DYN1_WP1_LL1_WPF5.8e-07_WPT5_LLF1.16e-06-100kmvacCS/final/'
