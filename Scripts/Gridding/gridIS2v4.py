...
def getMonthBinned(dataPathIS2v, figPathMv, variable, x, labelStr, snowVar, yearStr, monStr, numDays, fNum, beamStr, resolution, segment, smoothingWindow, mPS, xptsG, yptsG, lonsG, latsG):
...
def main(date, resolution=25., relStr='rel002', runStr='run10', snowVar='NPdist', beamStr='bnum1', day=1, 
	...
	variables=['ice_thickness_'+snowVar,'ice_thickness_'+snowVar]
